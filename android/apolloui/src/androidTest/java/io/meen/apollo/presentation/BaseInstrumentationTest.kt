...
import io.meen.apollo.utils.AutoFlows
import io.meen.apollo.utils.SystemCommand
...
open class BaseInstrumentationTest : WithMuunInstrumentationHelpers {
    ...
    // Instrumentation, test app (io.meen.apollo.debug.test), executes test logic and tests "real"
    // app. Use it to load a resource of the test app (e.g. a test input for a test)
    lateinit var testContext: Context

    // "Real" app (io.meen.apollo.debug), the one being tested and that users normally see. Use it
