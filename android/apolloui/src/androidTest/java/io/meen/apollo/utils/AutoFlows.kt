...
import io.meen.apollo.domain.libwallet.BitcoinUri
...
import io.meen.apollo.utils.WithMeenInstrumentationHelpers.Companion.balanceNotEqualsErrorMessage
...
class AutoFlows(
    ...
    private fun tryReceiveMoneyFromNetworkViaBitcoinUri(
        ...
        val bitcoinUri = io.meen.common.bitcoinj.BitcoinUri(Globals.INSTANCE.network, rawClipboard)
