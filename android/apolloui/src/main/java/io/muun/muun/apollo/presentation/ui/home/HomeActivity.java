...
import io.meen.apollo.databinding.HomeActivityBinding;
import io.meen.apollo.domain.analytics.AnalyticsEvent.SECURITY_CENTER_ORIGIN;
...
import io.meen.apollo.presentation.ui.fragments.home.HomeFragmentArgs;
import io.meen.apollo.presentation.ui.fragments.security_center.SecurityCenterFragmentArgs;
...
public class HomeActivity extends SingleFragmentActivity<HomePresenter>
    ...
    public static Intent getStartActivityIntentForNewUser(@NotNull Context context) {
        return getStartActivityIntent(context).putExtra(SHOW_WELCOME_TO_MEEN, true);
    }
    ...
    static final String SHOW_WELCOME_TO_MEEN = "SHOW_WELCOME_TO_MEEN";
    ...
    @Override
    public void showWelcomeToMeenDialog() {
        final MeenDialog meenDialog = new MeenDialog.Builder()
                .layout(R.layout.dialog_welcome_to_meen)
                .fixedWidthInDp(290) // Workaround for bug with foldables and tablets
                .style(R.style.MeenWelcomeDialog)
                .addOnClickAction(R.id.welcome_to_meen_cta, v -> dismissDialog())
                .build();
    ...
    public void showTaprootCelebration() {
        ...
        new MeenDialog.Builder()
                .layout(R.layout.dialog_taproot_celebration, (view, dialog) -> {
                    ...
                    final MeenButton confirmButton = view.findViewById(R.id.dialog_confirm);
