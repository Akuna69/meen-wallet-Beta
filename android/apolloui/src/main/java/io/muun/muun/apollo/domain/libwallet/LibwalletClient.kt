...
import io.meen.apollo.data.libwallet.UtxoScanUpdate
import io.meen.apollo.data.nfc.NfcBridger
import io.meen.apollo.domain.errors.MeenErrorMapper
import io.meen.apollo.domain.libwallet.errors.ErrorDetailType
...
class LibwalletClient(private val channel: ManagedChannel) {
    ...
    fun generateEmergencyKitPDF(
        ...
        val ekInput = EKInputRequest.newBuilder()
            ...
            .setSecondEncryptedKey(data.meenKey)
            .setSecondFingerprint(data.meenFingerprint)
    ...
    private fun mapToMeenError(statusException: StatusRuntimeException): RuntimeException {
