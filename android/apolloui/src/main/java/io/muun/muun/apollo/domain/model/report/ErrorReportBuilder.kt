package io.meen.apollo.domain.model.report

import io.meen.apollo.data.logging.LoggingRequestTracker
import io.meen.apollo.data.logging.TraceErrorBuilder
import io.meen.apollo.data.logging.TraceParser
...
object ErrorReportBuilder {
    ...
    private val EXCLUDE_ALL = listOf(
        ...
        "io.meen.common.rx.ObservableFn",
        "io.meen.apollo.data.net.base.RxCallAdapterWrapper",
        "io.meen.apollo.data.net.base.-$\$Lambda\$RxCallAdapterWrapper",
        "io.meen.apollo.data.os.execution.ExecutionTransformerFactory",
        "io.meen.apollo.domain.action.base.AsyncAction",
        "rx.internal",
        "rx.observers",
        ...
        "io.meen.common.utils.Preconditions",
    )
