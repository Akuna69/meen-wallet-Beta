...
import io.meen.apollo.domain.action.debug.BuildErrorEmailReportAction;
...
import io.meen.apollo.domain.errors.ExpiredSessionError;
import io.meen.apollo.domain.errors.SecureStorageError;
import io.meen.apollo.domain.errors.TooManyRequestsError;
...
public class BasePresenter<ViewT extends BaseView> implements Presenter<ViewT> {
    ...
    private void showErrorReportDialog(Throwable error, boolean standalone) {
        ...
        final MeenDialog.Builder builder = new MeenDialog.Builder()
        ...
        final MeenDialog meenDialog = builder.build();

        view.showDialog(meenDialog);
    }
        ...
        if (Email.INSTANCE.hasEmailAppInstalled(getContext())) {
            ...
            final MeenDialog meenDialog = new MeenDialog.Builder()
                    ...
                    .positiveButton(
                            ...
                            0,
                            () -> clipboardManager.copy("Meen Error Report", emailReport.getBody())
                    )
                    .negativeButton(R.string.cancel, 0, null)
                    .build();
