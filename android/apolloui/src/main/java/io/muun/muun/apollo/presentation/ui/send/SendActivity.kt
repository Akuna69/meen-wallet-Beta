...
import io.meen.apollo.databinding.ActivitySendBinding
...
import io.meen.apollo.presentation.ui.view.MeenButtonLayout
import io.meen.apollo.presentation.ui.view.MeenContactList
import io.meen.apollo.presentation.ui.view.MeenHeader
import io.meen.apollo.presentation.ui.view.MeenUriInput
...
class SendActivity : SingleFragmentActivity<SendPresenter>(), SendView {
    ...
    private val pasteButton: MeenButton
        get() = binding.pasteButton

    private val uriPaster: MeenUriPaster
        get() = binding.uriPaster

    private val uriInput: MeenUriInput
        get() = binding.uriInput

    private val uriStatusMessage: StatusMessage
        get() = binding.uriStatusMessage

    private val contactList: MeenContactList
    ...
    private val buttonLayout: MeenButtonLayout
    ...
    override fun setP2PState(state: P2PState) {
        ...
        // SORRY!
        // I made a mistake when writing MeenContactList: when showing an empty state, the view
