...
class MeenInfoBox @JvmOverloads constructor(c: Context, a: AttributeSet? = null, s: Int = 0) :
    MeenView(c, a, s) {

    companion object {
        val viewProps: ViewProps<MeenInfoBox> = ViewProps.Builder<MeenInfoBox>()
            .addRef(R.attr.pictureDrawable) { v, resId -> v.setPicture(resId) }
            .addString(R.attr.title) { v: MeenInfoBox, str: String -> v.setTitle(str) }
            .addString(R.attr.description) { v: MeenInfoBox, str: String ->
