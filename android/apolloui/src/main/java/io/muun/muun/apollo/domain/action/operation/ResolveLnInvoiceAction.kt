...
class ResolveLnInvoiceAction @Inject internal constructor(
    ...
    private fun validateSwap(
        ...
        val meenPublicKey: PublicKey = PublicKey.fromJson(fundingOutput.meenPublicKey)!!
        ...
        if (derivedPublicKeyPair.meenPublicKey != meenPublicKey) {
            return false
        }
    ...
    private fun createWitnessScript(
        ...
        val serverPublicKeyHash160 = Hashes.sha256Ripemd160(meenPublicKey)
