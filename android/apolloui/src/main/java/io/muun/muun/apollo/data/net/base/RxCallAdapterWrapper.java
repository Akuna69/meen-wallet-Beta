...
import io.meen.apollo.domain.errors.InvalidJsonError;
...
public class RxCallAdapterWrapper<R> implements CallAdapter<R, Object> {
    ...
    static {
        ...
        SPECIAL_HTTP_EXCEPTIONS_TRANSFORMER = ObservableFn.replaceTypedError(
                HttpException.class,
                error -> {
                    final var meenError = MeenErrorMapper.map(error.getErrorCode().getCode());
                    return meenError != null ? meenError : error;
                }
        );
    }
