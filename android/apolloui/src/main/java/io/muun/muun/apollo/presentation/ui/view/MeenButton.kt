...
import io.meen.apollo.databinding.MeenButtonBinding
import io.meen.apollo.presentation.ui.utils.UiUtils

class MeenButton @JvmOverloads constructor(c: Context, a: AttributeSet? = null, s: Int = 0) :
    MeenView(c, a, s) {

    companion object {
        val viewProps: ViewProps<MeenButton> = ViewProps.Builder<MeenButton>()
            .addString(android.R.attr.text) { obj: MeenButton, text: String -> obj.setText(text) }
            .addSize(android.R.attr.textSize) { obj: MeenButton, pixelSize: Int ->
                obj.setTextSize(pixelSize)
            }
            .addDimension(android.R.attr.layout_width) { obj: MeenButton, widthSpec: Int ->
                obj.setWidthSpec(widthSpec)
            }
            .addRef(android.R.attr.background) { obj: MeenButton, resId: Int ->
                obj.setBackgroundResource(resId)
            }
            .addBoolean(android.R.attr.textAllCaps) { obj: MeenButton, allCaps: Boolean ->
                obj.setTextAllCaps(allCaps)
            }
            .addSize(android.R.attr.paddingLeft) { obj: MeenButton, paddingLeft: Int ->
                obj.paddingLeft = paddingLeft
            }
            .addSize(android.R.attr.paddingTop) { obj: MeenButton, paddingTop: Int ->
                obj.paddingTop = paddingTop
            }
            .addSize(android.R.attr.paddingRight) { obj: MeenButton, paddingRight: Int ->
                obj.paddingRight = paddingRight
            }
            .addSize(android.R.attr.paddingBottom) { obj: MeenButton, paddingBottom: Int ->
                obj.paddingBottom = paddingBottom
            }
            .addInt(android.R.attr.textStyle) { obj: MeenButton, style: Int ->
                obj.setTextStyle(style)
            }
            .addColorList(android.R.attr.textColor) { obj: MeenButton, colors: ColorStateList ->
                obj.setTextColor(colors)
            }
            .addInt(android.R.attr.typeface) { obj: MeenButton, typefaceIndex: Int ->
                obj.setTypeface(typefaceIndex)
            }
            .addString(android.R.attr.fontFamily) { obj: MeenButton, fontFamily: String ->
    ...
    private val binding: MeenButtonBinding
        get() = getBinding() as MeenButtonBinding

    private val button: Button
        get() = binding.meenButtonButton

    private val progressBar: ProgressBar
        get() = binding.meenButtonProgressBar

    private val coverView: TextView
        get() = binding.meenButtonCover
    ...
    override val layoutResource: Int
        get() = R.layout.meen_button

    override fun viewBinder(): ((View) -> ViewBinding) {
        return MeenButtonBinding::bind
    }
    ...
    override fun setUp(context: Context, attrs: AttributeSet?) {
        ...
        if (backgroundRes == null) {
            backgroundRes = R.drawable.meen_button_default_bg
        }
