...
public class MeenTextInput extends MeenView implements DefaultLifecycleObserver {
    ...
    static final ViewProps<MeenTextInput> viewProps;

    static {
        final ViewProps.Builder<MeenTextInput> builder = new ViewProps.Builder<MeenTextInput>()
                .addStringJava(android.R.attr.text, MeenTextInput::setText)
                .addStringJava(R.attr.helperText, MeenTextInput::setHelperText)
                .addEnum(R.attr.helperTextVisibility, MeenTextInput::setHelperTextVisibilityEnum)
                .addStringJava(android.R.attr.hint, MeenTextInput::setHint)
                .addStringJava(android.R.attr.fontFamily, MeenTextInput::setFontFamily)
                .addBoolean(R.attr.hintEnabled, MeenTextInput::setHintEnabled)
                .addBoolean(R.attr.errorEnabled, MeenTextInput::setErrorEnabled)
                .addBoolean(android.R.attr.enabled, MeenTextInput::setEnabled)
                .addInt(android.R.attr.maxLines, MeenTextInput::setMaxLines)
                .addInt(android.R.attr.minEms, MeenTextInput::setMinEms)
                .addInt(android.R.attr.ems, MeenTextInput::setEms)
                .addInt(android.R.attr.maxEms, MeenTextInput::setMaxEms)
                .addInt(android.R.attr.maxLength, MeenTextInput::setMaxLength)
                .addInt(android.R.attr.gravity, MeenTextInput::setGravity)
                .addColorList(android.R.attr.textColor, MeenTextInput::setTextColor)
                .addEnum(android.R.attr.inputType, MeenTextInput::setInputType)
                .addRefJava(android.R.attr.nextFocusForward, MeenTextInput::setNextFocusForwardId)
                .addSizeJava(android.R.attr.textSize, MeenTextInput::setTextSize)
                .addEnum(android.R.attr.textStyle, MeenTextInput::setTextStyle)
                .addEnum(android.R.attr.imeOptions, MeenTextInput::setImeOptions)
                .addFloat(android.R.attr.letterSpacing, MeenTextInput::setLetterSpacing);
    ...
    @BindView(R.id.meen_text_input_layout)
    protected TextInputLayout layout;

    @BindView(R.id.meen_text_input_edit_text)
    protected TextInputEditText editText;

    @BindView(R.id.meen_helper_text)
    ...
    public MeenTextInput(Context context) {
        super(context);
    }

    public MeenTextInput(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenTextInput(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_text_input;
    }
    ...
    private void preloadErrorView() {
        ...
        // avoid jumps on the MeenTextInput layout after showing an error.
        if (!isInEditMode()) {
    ...
    /**
     * Reveal or hide the contents of this MeenTextInput.
     */
    ...
    /**
     * Sets a helper message that will be displayed below our {@link MeenTextInput}. If the
     ...
     * See: {@link MeenTextInput#updateHelperText()}
     * See: {@link MeenTextInput#setHelperText(CharSequence)}
     */
    ...
    /**
     * Focus on this MeenTextInput and show the soft keyboard.
