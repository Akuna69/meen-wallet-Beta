...
class MeenTaskCard @JvmOverloads constructor(c: Context, a: AttributeSet? = null, s: Int = 0):
    MeenView(c, a, s) {
    ...
    var status: Status = Status.DEFAULT
        set(newStatus) {
            val bgRes = when (newStatus) {
                Status.DEFAULT -> R.drawable.meen_task_card_default_bg
                Status.INACTIVE -> R.drawable.meen_task_card_inactive_bg
                Status.ACTIVE -> R.drawable.meen_task_card_active_bg
                Status.DONE -> R.drawable.meen_task_card_done_bg
                Status.SKIPPED -> R.drawable.meen_task_card_skipped_bg
            }
