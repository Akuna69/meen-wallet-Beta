...
import io.meen.apollo.data.preferences.UserRepository.StoredUserJson
import io.meen.apollo.data.preferences.adapter.JsonPreferenceAdapter
import io.meen.apollo.data.preferences.rx.Preference
import io.meen.apollo.data.preferences.stored.StoredEkVerificationCodes
...
class UserRepository @Inject constructor(
    ...
    companion object {
        ...
        private const val SEEN_WELCOME_TO_MEEN_DIALOG_KEY = "seen_welcome_to_meen_dialog_key"
    ...
    private val seenWelcomeToMeenDialogPreference: Preference<Boolean>
        get() = rxSharedPreferences.getBoolean(SEEN_WELCOME_TO_MEEN_DIALOG_KEY, false)
    ...
    /**
     * Save a flag signalling that the "Welcome to Meen" dialog has been shown/seen.
     */
    fun setWelcomeToMeenDialogSeen() {
        seenWelcomeToMeenDialogPreference.set(true)
    }

    /**
     * Get whether the user has seen the "Welcome to Meen" dialog or not.
     */
    val welcomeToMeenDialogSeen: Boolean
        get() = seenWelcomeToMeenDialogPreference.get()!!
