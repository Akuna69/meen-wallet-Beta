...
import io.meen.apollo.data.os.sharer.FileSharer
...
import io.meen.apollo.presentation.ui.utils.postDelayed
...
import io.meen.apollo.presentation.ui.view.MeenSaveOption
import io.meen.apollo.presentation.ui.view.MeenSaveOptionLabel
...
class EmergencyKitSaveFragment : SingleFragment<EmergencyKitSavePresenter>(),
    ...
    lateinit var saveToDriveOption: MeenSaveOption

    @BindView(R.id.save_option_feedback)
    lateinit var cloudFeedbackOption: MeenSaveOption
    ...
    override fun initializeUi(view: View) {
        saveToDriveOption.labelKind = MeenSaveOptionLabel.Kind.RECOMMENDED
    ...
    private fun initCloudFeedbackDialog(view: View, dialog: AlertDialog) {
        ...
        val feedbackInput = view.findViewById<MeenTextInput>(R.id.dialog_input)
        val confirmButton = view.findViewById<MeenButton>(R.id.dialog_confirm)
