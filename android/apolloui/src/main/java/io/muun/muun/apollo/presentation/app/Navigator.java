...
import io.meen.apollo.presentation.app.di.PerApplication;
import io.meen.apollo.presentation.ui.activity.operations.OperationsActivity;
import io.meen.apollo.presentation.ui.base.SingleFragment;
import io.meen.apollo.presentation.ui.base.SingleFragmentActivityImpl;
import io.meen.apollo.presentation.ui.debug.DebugPanelActivity;
import io.meen.apollo.presentation.ui.debug.securekv.DebugSecureKeyValueStorageActivity;
import io.meen.apollo.presentation.ui.diagnostic.DiagnosticActivity;
import io.meen.apollo.presentation.ui.export_keys.EmergencyKitActivity;
import io.meen.apollo.presentation.ui.feedback.anon.AnonFeedbackActivity;
import io.meen.apollo.presentation.ui.feedback.email.FeedbackActivity;
import io.meen.apollo.presentation.ui.fragments.need_recovery_code.NeedRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.fragments.need_recovery_code.NeedRecoveryCodeFragment.Flow;
import io.meen.apollo.presentation.ui.high_fees.HighFeesExplanationActivity;
import io.meen.apollo.presentation.ui.home.HomeActivity;
import io.meen.apollo.presentation.ui.launcher.LauncherActivity;
import io.meen.apollo.presentation.ui.lnurl.intro.LnUrlIntroActivity;
import io.meen.apollo.presentation.ui.lnurl.withdraw.LnUrlWithdrawActivity;
import io.meen.apollo.presentation.ui.lnurl.withdraw.confirm.LnUrlWithdrawConfirmActivity;
import io.meen.apollo.presentation.ui.migration.MigrationActivity;
import io.meen.apollo.presentation.ui.new_operation.NewOperationActivity;
import io.meen.apollo.presentation.ui.nfc.NfcReaderActivity;
import io.meen.apollo.presentation.ui.operation_detail.OperationDetailActivity;
import io.meen.apollo.presentation.ui.recovery_code.SetupRecoveryCodeActivity;
import io.meen.apollo.presentation.ui.recovery_tool.RecoveryToolActivity;
import io.meen.apollo.presentation.ui.scan_qr.LnUrlFlow;
import io.meen.apollo.presentation.ui.scan_qr.ScanQrActivity;
import io.meen.apollo.presentation.ui.security_cards_card_detail.CardDetailActivity;
import io.meen.apollo.presentation.ui.security_cards_country_picker.CountryPickerActivity;
import io.meen.apollo.presentation.ui.security_cards_country_picker.models.CountryInfo;
import io.meen.apollo.presentation.ui.security_cards_full_specs.SecurityCardsFullSpecsActivity;
import io.meen.apollo.presentation.ui.security_cards_marketplace.SecurityCardsMarketplaceActivity;
import io.meen.apollo.presentation.ui.security_cards_marketplace.models.MarketplaceFooter;
...
import io.meen.apollo.presentation.ui.security_cards_onboarding.SecurityCardsOnboardingActivity;
import io.meen.apollo.presentation.ui.security_cards_shipping_address.ShippingAddressActivity;
import io.meen.apollo.presentation.ui.security_logout.SecurityLogoutActivity;
import io.meen.apollo.presentation.ui.select_bitcoin_unit.SelectBitcoinUnitActivity;
import io.meen.apollo.presentation.ui.select_night_mode.SelectNightModeActivity;
import io.meen.apollo.presentation.ui.send.SendActivity;
import io.meen.apollo.presentation.ui.settings.edit_password.EditPasswordActivity;
import io.meen.apollo.presentation.ui.settings.edit_username.EditUsernameActivity;
import io.meen.apollo.presentation.ui.settings.success_delete_wallet.SuccessDeleteWalletActivity;
import io.meen.apollo.presentation.ui.setup_p2p.SetupP2PActivity;
import io.meen.apollo.presentation.ui.setup_password.SetupPasswordActivity;
import io.meen.apollo.presentation.ui.show_qr.ShowQrActivity;
import io.meen.apollo.presentation.ui.signup.SignupActivity;
import io.meen.apollo.presentation.ui.single_action.SingleActionActivity;
import io.meen.apollo.presentation.ui.single_action.V2SingleActionActivity;
import io.meen.apollo.presentation.ui.taproot_setup.TaprootSetupActivity;
...
public class Navigator {
    ...
    private static final String PLAY_STORE_PACKAGE_NAME = "io.meen.apollo";
