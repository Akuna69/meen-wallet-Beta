package io.meen.apollo.data.db.operation
...
import io.meen.apollo.domain.selector.UtxoSetStateSelector.UtxoSetState
...
open class OperationDao @Inject constructor() : HoustonIdDao<Operation>("operations") {
    ...
    private fun fromAllFields(
        ...
        fundingOutputMeenPublicKey: String?,
        fundingOutputMeenPublicKeyPath: String?,
        ...
        if (swapId != null) {
            ...
            val meenPublicKey = if (fundingOutputMeenPublicKey != null) {
                PublicKey.deserializeFromBase58(
                    checkNotNull(fundingOutputMeenPublicKeyPath),
                    fundingOutputMeenPublicKey
                )
            } else {
                null
            }
