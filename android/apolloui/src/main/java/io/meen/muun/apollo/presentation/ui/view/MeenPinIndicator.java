...
import io.meen.apollo.databinding.MeenPinIndicatorBinding;
...
public class MeenPinIndicator extends MeenView {

    static final ViewProps<MeenPinIndicator> viewProps = new ViewProps.Builder<MeenPinIndicator>()
            .addInt(R.attr.length, MeenPinIndicator::setLength)
            .build();
    ...
    private final Drawable bubbleBackgroundOn =
            ContextCompat.getDrawable(getContext(), R.drawable.meen_bubble_on);

    private final Drawable bubbleBackgroundOff =
            ContextCompat.getDrawable(getContext(), R.drawable.meen_bubble_off);

    private final Drawable bubbleBackgroundSuccess =
            ContextCompat.getDrawable(getContext(), R.drawable.meen_bubble_success);

    private final Drawable bubbleBackgroundError =
            ContextCompat.getDrawable(getContext(), R.drawable.meen_bubble_error);

    private MeenPinIndicatorBinding binding;

    @Override
    public Function1<View, ViewBinding> viewBinder() {
        return MeenPinIndicatorBinding::bind;
    }
    ...
    public MeenPinIndicator(Context context) {
        super(context);
    }

    public MeenPinIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenPinIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_pin_indicator;
    }

    @Override
    protected void setUp(@NonNull Context context, @Nullable AttributeSet attrs) {
        super.setUp(context, attrs);
        binding = (MeenPinIndicatorBinding) getBinding();
