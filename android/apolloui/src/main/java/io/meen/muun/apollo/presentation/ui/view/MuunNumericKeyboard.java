...
public class MeenNumericKeyboard extends MeenView {
    ...
    public MeenNumericKeyboard(Context context) {
        super(context);
    }

    public MeenNumericKeyboard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenNumericKeyboard(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_numeric_keyboard;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Do not allow MeenNumericKeyboard to take more width than MAX_WIDTH_DP.
