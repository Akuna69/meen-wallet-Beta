...
public class MeenLockOverlay extends MeenView {
    ...
    public MeenLockOverlay(Context context) {
        super(context);
    }

    public MeenLockOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenLockOverlay(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_lock_overlay;
    }
    ...
    public void reportSuccess() {
        Timber.i("MeenLockOverlay: reportSuccess");
