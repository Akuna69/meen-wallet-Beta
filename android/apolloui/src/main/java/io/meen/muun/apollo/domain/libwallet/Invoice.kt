...
import io.meen.apollo.domain.libwallet.errors.InvoiceParsingError
...
object Invoice {
    ...
    fun generateSecrets(publicKeyPair: PublicKeyPair): SecretList {
        ...
        val secrets = Libwallet.generateInvoiceSecrets(
            ...
            publicKeyPair.meenPublicKey.toLibwallet(networkParameters),
        )
    ...
    class InvoiceSecret(secret: InvoiceSecrets) {
        ...
        val meenPublicKey: PublicKey = Extensions.fromLibwallet(secret.meenHtlcKey)
