...
import io.meen.apollo.data.ExtensionsKt;
...
public class ExchangeRateWindow {
    ...
    public static ExchangeRateWindow fromJson(io.meen.common.api.ExchangeRateWindow json) {
    ...
    public io.meen.common.api.ExchangeRateWindow toJson() {
        return new io.meen.common.api.ExchangeRateWindow(
                windowHid,
