package io.meen.apollo.presentation.ui.base;
...
import io.meen.apollo.domain.action.permission.UpdateNotificationPermissionStateAction;
...
import io.meen.apollo.presentation.app.di.ApplicationComponent;
import io.meen.apollo.presentation.ui.activity.extension.AlertDialogExtension;
import io.meen.apollo.presentation.ui.activity.extension.ApplicationLockExtension;
import io.meen.apollo.presentation.ui.activity.extension.ExternalResultExtension;
import io.meen.apollo.presentation.ui.activity.extension.ExternalResultExtension.Caller;
import io.meen.apollo.presentation.ui.activity.extension.MeenDialog;
import io.meen.apollo.presentation.ui.activity.extension.PermissionManagerExtension;
import io.meen.apollo.presentation.ui.activity.extension.PermissionManagerExtension.PermissionRequester;
import io.meen.apollo.presentation.ui.activity.extension.PersistentPresenterExtension;
import io.meen.apollo.presentation.ui.activity.extension.ScreenshotBlockExtension;
import io.meen.apollo.presentation.ui.activity.extension.ShakeToDebugExtension;
import io.meen.apollo.presentation.ui.activity.extension.SnackBarExtension;
import io.meen.apollo.presentation.ui.base.di.ActivityComponent;
import io.meen.apollo.presentation.ui.utils.BundleSizeLogger;
...
public abstract class BaseActivity<PresenterT extends Presenter> extends ExtensibleActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        try {
            ...
            // prevent redrawing
            io.meen.apollo.presentation.ui.utils.ExtensionsKt.setWindowInsetsCompat(this);
            setUpLayout();
    ...
    /**
     * Show a simple, standard meen error dialog.
     */
    @Override
     ...
     */
    @Override
    public void showDialog(MeenDialog dialog) {
