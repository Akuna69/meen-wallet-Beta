...
import io.meen.apollo.data.afs.BuildInfo;
import io.meen.apollo.data.afs.PackageManagerAppInfo;
import io.meen.apollo.data.afs.PackageManagerDeviceFeatures;
...
import io.meen.apollo.domain.model.BackgroundEvent;
...
import io.meen.apollo.domain.model.InstallSourceInfo;
...
import io.meen.common.api.AndroidAppInfoJson;
import io.meen.common.api.AndroidDeviceFeaturesJson;
import io.meen.common.api.BackgroundEventJson;
import io.meen.common.api.BitcoinAmountJson;
import io.meen.common.api.ChallengeKeyJson;
...
import io.meen.common.api.ClientJson;
...
import io.meen.common.api.SensorEventJson;
...
public class ApiObjectsMapper {
    ...
    public UserInvoiceJson mapUserInvoice(final Invoice.InvoiceSecret invoice) {
        return new UserInvoiceJson(
                ...
                mapPublicKey(invoice.getMeenPublicKey()),
    ...
    public IncomingSwapFulfillmentData mapFulfillmentData(
        ...
        return new IncomingSwapFulfillmentData(
                ...
                Encodings.hexToBytes(json.meenSignatureHex),
                json.outputPath,
                json.outputVersion
        );
    }
