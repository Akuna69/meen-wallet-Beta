...
import io.meen.apollo.domain.action.images.DecodeImageAction;
import io.meen.apollo.domain.errors.UserFacingError;
import io.meen.apollo.domain.errors.p2p.InvalidPictureError;
...
public class MeenPictureInput extends MeenView {
    ...
    @BindView(R.id.meen_picture_input_button)
    protected ProfilePictureView profilePictureView;

    @BindView(R.id.meen_button_progress_bar)
    ...
    public MeenPictureInput(Context context) {
        super(context);
    }

    public MeenPictureInput(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenPictureInput(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_picture_input;
    }
    ...
    public void onExternalResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            ...
            default:
                throw new MissingCaseError(requestCode, "MeenPictureInput requestCode");
        }
    }
    ...
    private void onDrawerResult(int resultCode) {
        switch (resultCode) {
            ...
            default:
                throw new MissingCaseError(resultCode, "MeenPictureInput drawer actionId");
        }
    }
