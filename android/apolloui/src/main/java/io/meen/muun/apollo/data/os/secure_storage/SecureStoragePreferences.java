...
import io.meen.apollo.data.preferences.adapter.JsonListPreferenceAdapter;
import io.meen.apollo.data.preferences.rx.Preference;
import io.meen.apollo.data.preferences.rx.RxSharedPreferences;
...
public class SecureStoragePreferences {
    ...
    private static final String STORAGE_NAME = "meen-secure-storage";
