...
import io.meen.apollo.domain.utils.EK_CHILD_GO_COMPONENTS_RENDERING
import io.meen.apollo.domain.utils.EK_CHILD_GO_CREATE_AND_SAVE_ON_DISK
import io.meen.apollo.domain.utils.EK_CHILD_GO_EMBED_METADATA
import io.meen.apollo.domain.utils.EK_CHILD_GO_LOAD_TRANSLATIONS
import io.meen.apollo.domain.utils.EK_CHILD_GO_REGISTER_FONTS
import io.meen.apollo.domain.utils.EK_CHILD_GO_REGISTER_IMAGES
import io.meen.apollo.domain.utils.EK_CHILD_GO_TOTAL_HEAP_ALLOCATED
import io.meen.apollo.domain.utils.EK_CHILD_GO_TOTAL_INSIDE_GO
import io.meen.apollo.domain.utils.EK_CHILD_GO_TOTAL_OBJECTS_ALLOCATED
...
class GenerateEmergencyKitPDF @Inject constructor(
    ...
    private fun watchData(): Observable<RequiredData> {
        ...
        val tMeenKey = trace.child(EK_CHILD_MEEN_KEY)
        val tMeenFp = trace.child(EK_CHILD_MEEN_FINGERPRINT)
