...
import io.meen.apollo.presentation.ui.bundler.MonetaryAmountBundler
import io.meen.apollo.presentation.ui.helper.MoneyHelper
import io.meen.apollo.presentation.ui.utils.locale
import io.meen.apollo.presentation.ui.utils.setDrawableTint
...
class EditAmountItem @JvmOverloads constructor(c: Context, a: AttributeSet? = null, s: Int = 0) :
    ...
    @BindColor(R.color.meen_button_primary_bg_disabled)
    @JvmField
