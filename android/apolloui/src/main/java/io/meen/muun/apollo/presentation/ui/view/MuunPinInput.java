...
import io.meen.apollo.databinding.MeenPinInputBinding;
import io.meen.apollo.presentation.ui.view.MeenPinIndicator.PinIndicatorState;
...
public class MeenPinInput extends MeenView {
    ...
    static final ViewProps<MeenPinInput> viewProps = new ViewProps.Builder<MeenPinInput>()
            .addRefJava(R.attr.title, MeenPinInput::setTitle)
            .addRefJava(R.attr.description, MeenPinInput::setDescription)
            .addInt(R.attr.pinLength, MeenPinInput::setPinLength)
            .build();

    private MeenPinInputBinding binding;

    @Override
    public Function1<View, ViewBinding> viewBinder() {
        return MeenPinInputBinding::bind;
    }
    ...
    public MeenPinInput(Context context) {
        super(context);
    }

    public MeenPinInput(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenPinInput(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_pin_input;
    }
    ...
    protected void setUp(Context context, @Nullable AttributeSet attrs) {
        ...
        binding = (MeenPinInputBinding) getBinding();
    ...
    /**
     * Sets the description resource, i.e.: "You will use this code to unlock meen".
     * @param resId title resource.
     */
    ...
    private class KeyboardListener implements MeenNumericKeyboard.OnKeyListener {
        @Override
