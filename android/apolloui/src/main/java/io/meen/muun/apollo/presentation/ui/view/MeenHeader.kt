...
class MeenHeader : MeenView {

    companion object {
        val viewProps: ViewProps<MeenHeader> = ViewProps.Builder<MeenHeader>()
            .addBoolean(R.attr.elevated) { obj: MeenHeader, isElevated: Boolean ->
                obj.setElevated(isElevated)
            }
            .addRef(R.attr.titleTextAppearance) { obj: MeenHeader, id: Int ->
    ...
    @BindView(R.id.meen_header_toolbar)
    lateinit var toolbar: Toolbar

    @BindView(R.id.meen_header_indicator_text)
    lateinit var indicatorText: TextView

    @BindView(R.id.meen_header_drop_shadow)
