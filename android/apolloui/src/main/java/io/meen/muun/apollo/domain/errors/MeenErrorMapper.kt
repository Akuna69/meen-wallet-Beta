...
import io.meen.apollo.domain.errors.newop.InvalidAddressError
import io.meen.apollo.domain.errors.nfc.NoFeasibleZoneForModelError
import io.meen.apollo.domain.errors.p2p.CountryNotSupportedError
import io.meen.apollo.domain.errors.p2p.ExpiredVerificationCodeError
import io.meen.apollo.domain.errors.p2p.InvalidPhoneNumberError
import io.meen.apollo.domain.errors.p2p.InvalidVerificationCodeError
import io.meen.apollo.domain.errors.p2p.PhoneNumberAlreadyUsedError
import io.meen.apollo.domain.errors.p2p.RevokedVerificationCodeError
import io.meen.apollo.domain.errors.p2p.TooManyWrongVerificationCodesError
import io.meen.apollo.domain.errors.passwd.EmailAlreadyUsedError
import io.meen.apollo.domain.errors.passwd.EmailNotRegisteredError
import io.meen.apollo.domain.errors.passwd.IncorrectPasswordError
import io.meen.apollo.domain.errors.rc.CredentialsDontMatchError
import io.meen.apollo.domain.errors.rc.InvalidRecoveryCodeV2Error
