...
public class KeyStoreProvider {
    ...
    private static final String MEEN_KEY_STORE_PREFIX = "meen_key_store_";

    private static final X500Principal
            SUBJECT = new X500Principal("CN=io.meen.apollo, O=Android Authority");
    ...
    private KeyStore loadKeystore() {
        try {
            ...
            Timber.e(e);
            throw new MeenKeyStoreException(e);
        }
    }

    @NotNull
    private String getAlias(String keyAlias) {
        return MEEN_KEY_STORE_PREFIX + keyAlias;
    }
    ...
    public void wipe() {
        ...
        for (String alias : allKeysAliases) {
            if (alias.startsWith(MEEN_KEY_STORE_PREFIX)) {
                try {
                ...
                Timber.e(new MeenKeyStoreException(
    ...
    Set<String> getAllLabels() throws MeenKeyStoreException {
        try {
