...
import io.meen.apollo.presentation.model.text_decoration.AutoSizeDecoration;
import io.meen.apollo.presentation.model.text_decoration.DecorationTransformation;
import io.meen.apollo.presentation.model.text_decoration.MoneyDecoration;
import io.meen.apollo.presentation.model.text_decoration.TextDecorator;
import io.meen.apollo.presentation.ui.helper.MoneyExtensionsKt;
...
import io.meen.common.utils.MoneyUtils;
...
public class MeenAmountInput extends MeenView {
    ...
    static final ViewProps<MeenAmountInput> viewProps
            = new ViewProps.Builder<MeenAmountInput>()
            .addFloat(R.attr.textMaxWidthPercent, MeenAmountInput::setTextMaxWidthPercent)
            .build();
    ...
    // Components:
    @BindView(R.id.meen_amount)
    MeenEditText inputAmount;
    ...
    public MeenAmountInput(Context context) {
        super(context);
    }

    public MeenAmountInput(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenAmountInput(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * Focus on this MeenAmountInput and show the soft keyboard.
