...
import io.meen.apollo.data.di.DataModule
...
import io.meen.apollo.domain.BackgroundTimesProcessor
...
import io.meen.apollo.domain.action.session.DetectAppUpdateAction
import io.meen.apollo.domain.analytics.Analytics
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_APP_WILL_ENTER_FOREGROUND
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_APP_WILL_GO_TO_BACKGROUND
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_APP_WILL_TERMINATE
import io.meen.apollo.domain.libwallet.LibwalletBridge
import io.meen.apollo.domain.model.NightMode
import io.meen.apollo.domain.model.NightMode.DARK
import io.meen.apollo.domain.model.NightMode.FOLLOW_SYSTEM
import io.meen.apollo.domain.model.NightMode.LIGHT
import io.meen.apollo.domain.model.feebump.FeeBumpRefreshPolicy
import io.meen.apollo.domain.sync.FeeDataSyncer
import io.meen.apollo.presentation.app.di.ApplicationComponent
import io.meen.apollo.presentation.app.di.DaggerApplicationComponent
import io.meen.apollo.presentation.app.startup.AppStartupInitializer
import io.meen.apollo.presentation.ui.utils.UserFacingErrorMessagesImpl
