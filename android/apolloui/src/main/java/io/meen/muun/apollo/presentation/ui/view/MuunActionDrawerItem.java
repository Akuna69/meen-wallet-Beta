...
public class MeenActionDrawerItem extends MeenView {

    @BindView(R.id.meen_action_drawer_item_icon)
    ImageView icon;

    @BindView(R.id.meen_action_drawer_item_label)
    TextView label;
    ...
    public MeenActionDrawerItem(Context context) {
        super(context);
    }

    public MeenActionDrawerItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MeenActionDrawerItem(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    protected int getLayoutResource() {
        return R.layout.meen_action_drawer_item;
    }
