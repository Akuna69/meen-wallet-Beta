...
import io.meen.apollo.presentation.ui.fragments.create_email_help.CreateEmailHelpFragment;
...
import io.meen.apollo.presentation.ui.fragments.ek_success.EmergencyKitSuccessFragment;
...
import io.meen.apollo.presentation.ui.fragments.explanation_block.ExplanationPageFragment;
import io.meen.apollo.presentation.ui.fragments.home.HomeFragment;
...
import io.meen.apollo.presentation.ui.fragments.manual_fee.ManualFeeFragment;
...
import io.meen.apollo.presentation.ui.fragments.phone_number.PhoneNumberFragment;
import io.meen.apollo.presentation.ui.fragments.profile.ProfileFragment;
...
import io.meen.apollo.presentation.ui.fragments.recommended_fee.RecommendedFeeFragment;
import io.meen.apollo.presentation.ui.fragments.recovery_tool.RecoveryToolFragment;
import io.meen.apollo.presentation.ui.fragments.security_center.SecurityCenterFragment;
import io.meen.apollo.presentation.ui.fragments.settings.SettingsFragment;
...
import io.meen.apollo.presentation.ui.fragments.sync_contacts.SyncContactsFragment;
import io.meen.apollo.presentation.ui.fragments.tr_clock_detail.TaprootClockDetailFragment;
...
import io.meen.apollo.presentation.ui.fragments.verification_code.VerificationCodeFragment;
import io.meen.apollo.presentation.ui.fragments.verify_email.VerifyEmailFragment;
import io.meen.apollo.presentation.ui.recovery_code.accept.AcceptRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.recovery_code.priming.PrimingRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.recovery_code.show.ShowRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.recovery_code.success.SuccessRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.recovery_code.verify.VerifyRecoveryCodeFragment;
import io.meen.apollo.presentation.ui.security_cards_marketplace.SecurityCardProviderFragment;
import io.meen.apollo.presentation.ui.settings.EmailWaitFragment;
import io.meen.apollo.presentation.ui.settings.OldPasswordFragment;
import io.meen.apollo.presentation.ui.settings.RecoveryCodeFragment;
import io.meen.apollo.presentation.ui.settings.bitcoin.BitcoinSettingsFragment;
import io.meen.apollo.presentation.ui.settings.edit_password.ChangePasswordFragment;
import io.meen.apollo.presentation.ui.settings.edit_password.StartPasswordChangeFragment;
import io.meen.apollo.presentation.ui.settings.edit_password.success.EditPasswordSuccessFragment;
import io.meen.apollo.presentation.ui.settings.flags.DisableFeatureFlagsFragment;
import io.meen.apollo.presentation.ui.settings.lightning.LightningSettingsFragment;
...
import io.meen.apollo.presentation.ui.show_qr.unified.ShowUnifiedQrFragment;
