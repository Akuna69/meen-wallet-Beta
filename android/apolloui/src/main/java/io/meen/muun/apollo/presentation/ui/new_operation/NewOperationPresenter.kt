...
import io.meen.apollo.domain.action.base.CombineLatestAsyncAction
...
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_NEW_OP_ACTION_TYPE
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_NEW_OP_COMPLETED
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_NEW_OP_SUBMITTED
import io.meen.apollo.domain.analytics.AnalyticsEvent.E_NEW_OP_TYPE.Companion.fromModel
import io.meen.apollo.domain.analytics.AnalyticsEvent.S_NEW_OP_ORIGIN.Companion.fromModel
import io.meen.apollo.domain.analytics.NewOperationOrigin
import io.meen.apollo.domain.errors.BugDetected
import io.meen.apollo.domain.errors.UserFacingError
import io.meen.apollo.domain.errors.newop.AmountTooSmallError
import io.meen.apollo.domain.errors.newop.CyclicalSwapError
import io.meen.apollo.domain.errors.newop.ExchangeRateWindowTooOldError
import io.meen.apollo.domain.errors.newop.InsufficientFundsError
import io.meen.apollo.domain.errors.newop.InvalidInvoiceException
import io.meen.apollo.domain.errors.newop.InvalidSwapException
import io.meen.apollo.domain.errors.newop.InvoiceAlreadyUsedException
import io.meen.apollo.domain.errors.newop.InvoiceExpiredException
import io.meen.apollo.domain.errors.newop.InvoiceExpiresTooSoonException
import io.meen.apollo.domain.errors.newop.InvoiceMissingAmountException
import io.meen.apollo.domain.errors.newop.NoPaymentRouteException
import io.meen.apollo.domain.errors.newop.SwapFailedException
import io.meen.apollo.domain.errors.newop.UnreachableNodeException
import io.meen.apollo.domain.libwallet.Invoice.parseInvoice
...
import io.meen.apollo.domain.model.PaymentRequest.Type
...
import io.meen.apollo.domain.selector.ExchangeRateSelector
import io.meen.apollo.domain.selector.FeatureSelector
import io.meen.apollo.domain.selector.PaymentContextSelector
import io.meen.apollo.presentation.ui.base.BasePresenter
import io.meen.apollo.presentation.ui.base.di.PerActivity
import io.meen.apollo.presentation.ui.fragments.manual_fee.ManualFeeParentPresenter
import io.meen.apollo.presentation.ui.fragments.new_op_error.NewOperationErrorParentPresenter
import io.meen.apollo.presentation.ui.fragments.new_op_error.NewOperationErrorParentPresenter.ErrorMetadata
import io.meen.apollo.presentation.ui.fragments.recommended_fee.RecommendedFeeParentPresenter
import io.meen.apollo.presentation.ui.new_operation.NewOperationView.Receiver
