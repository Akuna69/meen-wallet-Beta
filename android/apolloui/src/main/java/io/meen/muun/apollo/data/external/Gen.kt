...
import io.meen.apollo.domain.model.SubmarineSwapBestRouteFees
import io.meen.apollo.domain.model.SubmarineSwapFees
import io.meen.apollo.domain.model.SubmarineSwapFundingOutput
import io.meen.apollo.domain.model.SubmarineSwapFundingOutputPolicies
...
import io.meen.common.model.EkVersion
...
object Gen {
     ...
     * Get a MeenAddress.
     */
    private fun meenAddress() =
        MeenAddress(1, "m/1/2/3", address())
    ...
    private fun submarineSwapFundingOutput(
        ...
        userLockTime: Int = 30,
        userRefundAddress: MeenAddress = meenAddress(),
        debtType: DebtType = DebtType.NONE,
        debtAmountInSatoshis: Long = 0,
    ) =
        SubmarineSwapFundingOutput(
