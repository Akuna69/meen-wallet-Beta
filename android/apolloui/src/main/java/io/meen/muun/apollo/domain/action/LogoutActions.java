...
import io.meen.apollo.domain.errors.UnrecoverableUserLogoutError;
...
import io.meen.apollo.domain.selector.LogoutOptionsSelector.LogoutOptions;
...
public class LogoutActions {
    ...
    private boolean isTesting() {
        try {
            Class.forName("io.meen.apollo.utils.AutoFlows");
            return true;
